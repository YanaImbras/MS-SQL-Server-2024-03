...
CREATE TABLE [Customer] (
  ...
  [CustomerType] nvarchar(250) NOT NULL,/*Тип поставщик\заказчик*/
...
--create index idx_OrderBox on [OrderBox] ([OrderBoxId]);
